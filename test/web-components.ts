...
const domainsForSbp = ["power", "waterUsage", "surface"];
sbPlot.setAttribute("content", content);
sbPlot.setAttribute("domains", domainsForSbp.toString());
sbPlot.setAttribute("x", "status");
sbPlot.setAttribute("y", "type");
sbPlot.setAttribute("fill", "power");
...
ac.setAttribute("title", "Data centers");
div2.append(ac);
